...
namespace adchpp
{
	...
	template <class T> struct PoolDummy
	{
		void operator()(T&)
		{
		}
	...
	template <typename T, class Clear = PoolDummy<T>> class SimplePool
	{
	public:
		SimplePool() : busy(0)
		{
	...
	template <class T, class Clear = PoolDummy<T>> class Pool
	{
	public:
		Pool()
		{
